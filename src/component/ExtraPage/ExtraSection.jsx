        ...
        <div>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {[
              ...
              <div
                key={i}
                className="p-5 rounded-xl shadow-md  hover:shadow-xl hover:-translate-y-2 transition duration-300 border"
              >
                <p className="">{item}</p>
              </div>
            ))}
        ...
        <div>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {heroes.map((hero, i) => (
              <div
                key={i}
                className="group rounded-xl shadow-md p-5 border cursor-pointer
                         hover:shadow-2xl hover:-translate-y-2 transition duration-300"
              >
                <div className="space-y-2">
                  <h3 className="font-bold text-lg group-hover:text-green-600 dark:group-hover:text-green-400 transition">
                    {hero.name}
                  </h3>
